...
public class HttpServletRequestMockImplTest {
	...
	public void testInstantiationByFactory() {
		...
		httpServletRequestMock = MockServletRequestFactory.createMockedRequest(mockedSession, params, attributes, CONTEXT_PATH, SERVER_NAME, Locale.ENGLISH, 80);
